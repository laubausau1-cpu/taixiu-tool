...
class PredictionEngine{
    ...
    load(){tryconst f=DATA_DIR+'/state.json';if(fs.existsSync(f))const d=JSON.parse(fs.readFileSync(f,'utf8'));if(d.history)this.history=d.history;if(d.stats)this.stats={...this.stats,...d.stats};if(d.predictionLog)this.predictionLog=d.predictionLog}}catch(e){}}
